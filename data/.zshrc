...
plugins=(git docker pip vagrant brew git-flow)
...
alias serve_this="echo '<<Running as root>>' && sudo python3 -m http.server 80"
...
POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=('status' 'os_icon' 'dir')
